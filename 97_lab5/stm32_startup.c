...
/* function prototypes of STM32F446xx system exception and handlers */
...
void FMPI2C1_EventHandler(void) __attribute__ ((weak, alias("Default_Handler")));
void FMPI2C1_ERROR_ErrorHandler(void) __attribute__ ((weak, alias("Default_Handler")));
...
uint32_t vectorTable[] __attribute__ ((section (".isr_vector"))) = {
	...
	(uint32_t)FMPI2C1_EventHandler,
	(uint32_t)FMPI2C1_ERROR_ErrorHandler
};
